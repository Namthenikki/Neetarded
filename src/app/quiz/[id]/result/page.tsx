                                        ...
                                        {q.options.map(opt => {
                                            ...
                                            return (
                                                <div key={opt.id}
                                                    ...
                                                    <span className="font-semibold mr-2 shrink-0">{opt.id}.</span>
                                                    {opt.imageUrl ? (
                                                        <Image src={opt.imageUrl} alt={`Option ${opt.id}`} width={300} height={150} className="max-h-24 w-auto object-contain rounded bg-white p-1" />
                                                    ) : (
                                                        opt.text
                                                    )}
                                                </div>
